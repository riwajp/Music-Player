...
class MusicPlayer {
    ...
    void print(sf::RenderWindow * window, sf::Event * event, ClickHandler * click_handler) {
        ...
        if (now_playing != NULL && now_playing -> isLoaded) {
			...
			Button pause(now_playing -> isPlaying ? "_pause.png" : "_play.png", 0.05, 0.05, bc_x, bc_y);
			...
			Button next("_next.png", 0.05, 0.05, bc_x+80, bc_y);
			...
			next.render(window,[this](){
         	...
         	Button previous("_previous.png", 0.05, 0.05, bc_x-80, bc_y);
			...
			Button shuffle(list -> shuffle ? "shuffle.png" : "unshuffle.png", list -> shuffle ? 0.04 : 0.055, list -> shuffle ? 0.04 : 0.055, bc_x + 160, bc_y);
            ...
            Button repeat(list -> repeat ? "repeat.png" : "unrepeat.png", list -> repeat ? 0.06 : 0.105, list -> repeat ? 0.06 : 0.105, bc_x - 160, bc_y);
